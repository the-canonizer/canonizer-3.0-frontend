...
export default class campNewsRequest extends Request {
  ...
  static addNewsDataRequest(reqBody,tokenBearer) {
    console.log("token in add ",tokenBearer)
    return new Request(
  ...
  static getCampEditNewsData(reqBody,tokenBearer) {
    console.log("token in edit ",tokenBearer)
    return new Request(
  ...
  static updateNewsData(reqBody,tokenBearer) {
   
    console.log("token in update ",tokenBearer)
    return new Request(
  ...
  static deleteNewsData(reqBody,tokenBearer) {
    console.log("token in delete ",tokenBearer)
    return new Request(
