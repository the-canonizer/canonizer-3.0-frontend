...
export const validations: ErrorContainer = {
  ...
  phoneMinLength: "Contact number must be at least 10 digits!",
  phoneMaxLength: "Contact number must be at least 10 digits!",
  validPhone: "Please input valid contact number!",
  ...
  topiNameMax80: "Maximum 80 character allowed!",
  topicNameSpace:
