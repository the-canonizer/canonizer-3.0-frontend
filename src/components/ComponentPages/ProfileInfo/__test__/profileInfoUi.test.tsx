...
import { getByText, render, screen, waitFor } from "../../../../utils/testUtils";
...
describe("sssfsf",()=>{
  ...
  it("render",()=>{
    const { getByTestId, container } = render(<ProfileInfoUI 
      form={null}
      formVerify={null}
    ...
    expect(component.parentElement.classList.contains(styles.profileInfo_wrapper)).toBe(true);
  })
