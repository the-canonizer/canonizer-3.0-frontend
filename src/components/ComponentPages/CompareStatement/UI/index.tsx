                    ...
                    {from == "camp" ? (
                      <Fragment>
                        ...
                        <Paragraph>
                          ...
                          <Text>
                            {validUrl(s1?.camp_about_url) ? <Link href={s1?.camp_about_url || ""}>
                    ...
                    {from == "camp" ? (
                      <Fragment>
                        ...
                        <Paragraph>
                          <Text strong>Camp About URL : </Text>
                          <Text>
                            {validUrl(s2?.camp_about_url) ? <Link href={s2?.camp_about_url || ""}>
                    ...
                    {from == "camp" ? (
                      <Fragment>
                        ...
                        <Paragraph>
                          <Text strong>Camp About URL : </Text>
                          <Text>
                            {validUrl(liveStatement?.camp_about_url) ? <Link href={liveStatement?.camp_about_url || ""}>
