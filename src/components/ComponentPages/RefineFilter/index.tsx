  ...
  return (
    <>
      <Drawer
        ...
        // closable={false}
        className="custom-collapse pt-14 lg:[&_.ant-drawer-header]:pl-8 [&_.ant-drawer-header]:pl-4 [&_.ant-drawer-header-title]:gap-5 [&_.ant-drawer-close]:!hidden lg:[&_.ant-drawer-close]:!flex lg:[&_.ant-drawer-close]:!m-0 [&_.ant-drawer-header-title]:!flex [&_.ant-drawer-header-title]:!items-center lg:[&_.ant-drawer-title]:text-base [&_.ant-drawer-title]:text-sm [&_.ant-drawer-title]:font-medium [&_.ant-drawer-title]:text-canBlack lg:[&_.ant-drawer-header-title]:pb-5 [&_.ant-drawer-title]:pb-0 lg:[&_.ant-drawer-header]:!border-none [&_.ant-drawer-header]:!border-canLightgrey4
