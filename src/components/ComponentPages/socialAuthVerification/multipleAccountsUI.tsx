      ...
      >
        <Form.Item>
          <Typography.Text>
            ...
            account and keep only a single master account active. If you do not
            want to deactivate then click on cancel and try linking with another
            email for this social account. If you wish to deactivate then select
            the account below and click submit.
          </Typography.Text>
        </Form.Item>
        <Form.Item
          name="selected_user"
