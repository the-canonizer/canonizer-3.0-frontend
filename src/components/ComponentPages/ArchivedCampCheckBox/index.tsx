...
import { setScoreCheckBox,setArchivedCheckBox } from "src/store/slices/utilsSlice";
...
const ArchivedCampCheckBox = () => {
  ...
  const setCheckboxStore = (val) => {dispatch(setArchivedCheckBox(val)),console.log(val,"val")};
