          ...
          {canonizedTopics?.topics?.map((item, index) => (
            <Col key={index} xs={24} sm={24} md={12}>
              <Card className="browse-card">
                ...
                <Tag className="bg-orange text-white border-0 rounded-md inline-flex py-[3px] items-center">
                  <svg
                    width="10"
                    height="13"
                    viewBox="0 0 13 16"
...

{
  /* <Col xs={24} sm={24} md={12}>
            <Card className="browse-card">
              <div className="mb-2.5 flex justify-between">
                <p className="font-medium">Is WikiLeaks Good?</p>
                <Button
                  className="btn-right"
                  type="link"
                  size="small"
              ...
              <Tag
                className={
                  "bg-orange text-white border-0 rounded-md inline-flex py-[3px] items-center"
                }
              >
                <svg
                  width="10"
          ...
          <Col xs={24} sm={24} md={12}>
            <Card className="browse-card">
              ...
              <List className="">
                <List.Item className="w-full flex font-medium p-0">
                  <div className="flex justify-between gap-7 w-full items-start flex-wrap">
                    <div className="text-left flex">
                      <Popover content="Share Topic" placement="top">
                        <Typography.Paragraph className="bg-transparent border-0 p-0 hover:bg-transparent focus:bg-transparent flex items-center leading-1 mb-0 mr-3">
                          <FlagOutlined className="text-[#242B37] p-1 text-base" />
