  ...
  return (
    <Layout className="bg-canGray rounded-lg py-6 lg:py-12 px-6 ">
      <Row
        ...
        className={`z-0 ${
          isUserAuthenticated
            ? "relative before:content-[''] z-1 before:w-full before:h-full before:absolute before:block before:bg-[url('/images/middle-vector.svg')] before:bg-no-repeat before:-bottom-6 md:before:-bottom-12 before:left-[50%] before:translate-x-[-50%] before:w-full before:bg-[length:200px_200px] lg:before:bg-contain before:bg-right-top md:before:bg-center lg:before:bg-center"
            : ""
        }`}
      >
