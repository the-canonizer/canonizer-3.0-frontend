...
const CampHistory = ({ campStatement, topicNamespaceId }: any) => {
    ...
    return (
        <>
            ...
            <p>
                Camp about URL:
                <span>{campStatement?.camp_about_url &&
            ...
            <p>
                Disable additional sub-camps: <span>{campStatement?.is_disabled == 1 ? "Yes" : "No"}</span>
            </p>
            <p>
                Single level Camps only:<span>{campStatement?.is_one_level == 1 ? "Yes" : "No"}</span>
            </p>
            <p>
