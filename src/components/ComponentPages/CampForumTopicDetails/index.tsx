              ...
              thread?.map((obj) => (
                ...
                >
                  <div className="w-full grid grid-rows-2 md:grid-flow-col center">
                    <Typography.Paragraph className="!mb-0 text-xs text-canBlack text-ellipsis font-medium row-start-1 md:row-start-0 col-span-2 md:col-span-2">
                      {obj.body}
                    </Typography.Paragraph>
                    <Typography.Paragraph className="text-canBlack text-opacity-50 font-medium text-[10px] !mb-0 flex items-center mt-1 row-start-2 row-span-2 col-span-2 md:col-span-2 md:row-start-0 md:row-span-0">
