              ...
              >
                ...
                <div className="flex gap-2 mt-2 items-center lg:flex-nowrap flex-wrap">
                  <Button
                    ...
                    className="text-canBlack border border-canGrey2 py-2.5 lg:px-5 !h-[44px] !w-auto refine-btn !text-base font-medium  flex items-center justify-center gap-2.5 rounded-lg   bg-canGray"
                  >
                    Consesnus Tree
                    <Image
                  ...
                  <Button
                    onClick={showDrawer}
                    className="text-canBlack py-2.5 lg:px-5 h-[34px] rounded-lg w-auto  text-base font-medium  flex items-center justify-center !border !border-canBlack"
                  >
                    Refine Filter
                    <Image
