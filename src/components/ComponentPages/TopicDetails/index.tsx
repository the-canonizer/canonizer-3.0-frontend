      ...
      <div className="pageContentWrap">
          ...
          title={
            <div className="cardHeader">
              ...
              <h3 className="heading-color">
                {" "}
                <i className={"icon-fi-document " + styles.iconMr} /> News Feeds
              </h3>
            </div>
          }
          extra={
        ...
        >
          ...
          <Paragraph>
            ...
            sciences, and the result is very different from what most would
            expect{" "}
          </Paragraph>
        </Card>
        ...
        >
          ...
          <Paragraph>
            ...
            theories of consciousness. Everyone is invited to contribute, as we
            want to track the default popular consensus. There is also the “Mind
            Expert” canonizer people can select, so people can compare the
            popular consensus with the “Expert Consensus”.
          </Paragraph>
          <Paragraph>
            {" "}
            We focus on bridging the <a> Explanatory Gap </a> to explore the
            qualitative nature of consciousness. We are asking the questions:
            “What are the physical properties of conscious experience?” Physical
